...
DE_BASE = [
    ...
    ["ZDF", 490.0, 375.0, 115.0, 70.0, 40.0, 15.0],
...
CA_BASE = [
    ...
    ["BELL MEDIA (CTV)", 914.0,  279.0,  635.0,  435.0,  300.0,  175.0],
...
SV_BASE = [
    ...
    ["MARKÍZA GROUP", 219.0, 95.0, 124.0, 84.0, 53.0, 26.0],
...
SLE_BASE = [
    ...
    ["PRO PLUS (POP TV)", 112.0, 48.0, 64.0, 44.0, 28.0, 14.0],
...
CRO_BASE = [
    ...
    ["RTL HRVATSKA", 206.0, 80.0, 126.0, 86.0, 55.0, 28.0],
...
BG_BASE = [
    ...
    ["bTV MEDIA GROUP", 292.0, 103.0, 189.0, 126.0, 83.0, 39.0],
    ...
    ["FACEBOOK", 56.0, 10.0, 46.0, 32.0, 20.0, 10.0]
]
...
MOL_BASE = [
    ...
    ["PRIME TV MOLDOVA", 77.0, 24.0, 53.0, 36.0, 24.0, 11.0],
...
CR_BASE = [
    ...
    ["TV NOVA", 487.0, 217.0, 270.0, 182.0, 115.0, 56.0],
