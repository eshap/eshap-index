...
# ==============================================================================
# CANONICAL REVISED BASE DATA LEDGERS (DEPLOYMENT BLOCK 1 OF 3)
...
DE_BASE = [
    ...
    ["ZDF", 485.0, 375.0, 110.0, 70.0, 40.0, 15.0],
...
MX_BASE = [
    ...
    ["IMAGEN TELEVISIÓN", 195.0, 145.0, 50.0, 32.0, 18.0, 8.0],
...
# ==============================================================================
# CANONICAL REVISED BASE DATA LEDGERS (DEPLOYMENT BLOCK 2 OF 3)
# Format: [Platform, All P13+, 55+ Layer, 13-54 Workfc, 13-44 Youth, 13-34 Core, 13-24 Gen Z]
# ==============================================================================
...
BG_BASE = [
    ...
    ["META",                           285.0,   45.0,  240.0,  195.0,  155.0,   95.0],
    ["bTV MEDIA GROUP (W/ VOYO)",      292.0,  103.0,  189.0,  126.0,   83.0,   39.0],
...
CA_BASE = [
    ...
    ["BELL MEDIA (CTV)", 697.0, 237.0, 460.0, 305.0, 205.0, 120.0],
...
CRO_BASE = [
    ...
    ["META",                           215.0,   35.0,  180.0,  148.0,  115.0,   72.0],
    ["RTL HRVATSKA (W/ VOYO)",         206.0,   80.0,  126.0,   86.0,   55.0,   28.0],
...
CR_BASE = [
    ...
    ["TV NOVA / ONEPLAY",              487.0,  217.0,  270.0,  182.0,  115.0,   56.0],
    ["META",                           440.0,   85.0,  355.0,  285.0,  210.0,  115.0],
...
DEN_BASE = [
    ["META", 235.0, 42.0, 193.0, 155.0, 118.0, 62.0],
    ["TV2 DANMARK", 222.0, 77.0, 145.0, 95.0, 60.0, 30.0],
...
FIN_BASE = [
    ...
    ["MTV3 (Telia Company)", 217.0, 97.0, 120.0, 78.0, 52.0, 24.0],
    ["META", 210.0, 38.0, 172.0, 138.0, 102.0, 52.0],
...
IN_BASE = [
    ...
    ["META", 2467.0, 177.0, 2290.0, 1860.0, 1420.0, 860.0],
...
JP_BASE = [
    ...
    ["META", 144.0, 82.8, 61.2, 37.4, 21.6, 8.6]
]

# ==============================================================================
# CANONICAL REVISED BASE DATA LEDGERS (DEPLOYMENT BLOCK 3 OF 3)
# Format: [Platform, All P13+, 55+ Layer, 13-54 Workfc, 13-44 Youth, 13-34 Core, 13-24 Gen Z]
# ==============================================================================

MOL_BASE = [
    ["YOUTUBE",                        151.0,   16.0,  135.0,  110.0,   88.0,   56.0],
    ["META",                           135.0,   22.0,  113.0,   92.0,   72.0,   38.0],
    ["TIKTOK",                         116.0,    1.0,  115.0,   95.0,   78.0,   58.0],
    ["M1 (Moldova 1)",                 112.0,   38.0,   74.0,   48.0,   31.0,   16.0],
    ["NETFLIX",                         81.0,    5.0,   76.0,   62.0,   44.0,   22.0],
    ["PRIME TV MOLDOVA (W/ LEAKED VOYO)", 77.0,  24.0,   53.0,   36.0,   24.0,   11.0],
...
NOR_BASE = [
    ...
    ["TV2 NORGE", 245.0, 97.0, 148.0, 98.0, 64.0, 31.0],
    ["META", 220.0, 38.0, 182.0, 145.0, 108.0, 56.0],
...
RO_BASE = [
    ...
    ["META",                           715.0,  145.0,  570.0,  445.0,  330.0,  175.0],
    ["NETFLIX",                        673.0,   38.0,  635.0,  510.0,  365.0,  185.0],
    ["ANTENA TV GROUP",                515.0,  153.0,  362.0,  255.0,  168.0,   82.0],
    ["PROTV (W/ VOYO)",                480.0,  165.0,  315.0,  200.0,  125.0,   65.0],
...
SV_BASE = [
    ...
    ["META",                           225.0,   48.0,  177.0,  140.0,  102.0,   50.0],
    ["MARKÍZA GROUP (W/ VOYO)",        219.0,   95.0,  124.0,   84.0,   53.0,   26.0],
...
SLE_BASE = [
    ...
    ["PRO PLUS (POP TV / VOYO)",       112.0,   48.0,   64.0,   44.0,   28.0,   14.0],
    ["YOUTUBE",                        116.0,   24.0,   92.0,   72.0,   55.0,   34.0],
    ["META",                           115.0,   24.0,  101.0,   81.0,   60.0,   31.0],
...
# Note: Added for completeness to line up with master text registry tokens
SK_BASE = [
    ...
    ["META", 595.0, 115.0, 480.0, 385.0, 285.0, 140.0],
...
SWE_BASE = [
    ...
    ["META", 325.0, 62.0, 263.0, 212.0, 155.0, 80.0],
