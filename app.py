...
with tab2:
    ...
    st.markdown("Please check out our Methodology Blueprint and Sourcing Matrix pages for more details on how we created this index, across.")
