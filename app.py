...
st.markdown("We will update this index monthly, with rolling six month data. Each month, we will drop our analysis of the latest data on **[Media War & Peace](https://eshap.substack.com/)**.", unsafe_allow_html=True)
