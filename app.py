...
st.markdown("We will update this index monthly, on a rolling six months basis.<br>Each month, we will drop our analysis of the latest data on **[Media War & Peace](https://substack.com)**.", unsafe_allow_html=True)
